...
public class WorkflowStartTest {
    ...
    public void tstWorkflowStartSuccess() throws Exception {
        ...
        Mockito.when(mockPutRequest.executeRequest()).thenReturn(new Response(mapper.createObjectNode(), 202, "Accepted"));
    ...
    public void tstWorkflowStartTokenSuccess() throws Exception {
        ...
        Mockito.when(mockPutRequestToken.executeRequest()).thenReturn(new Response(mapper.createObjectNode(), 202, "Accepted"));
