...
public class DsnCopyTest {
    ...
    public void tstDsnCopySuccess() throws ZosmfRequestException {
        final DsnCopy dsnCopy = new DsnCopy(connection, mockJsonPutRequest);
        final Response response = dsnCopy.copy("from", "to", true, true);
    ...
    public void tstDsnCopyTokenSuccess() throws ZosmfRequestException {
        final DsnCopy dsnCopy = new DsnCopy(connection, mockJsonPutRequestToken);
        final Response response = dsnCopy.copy("from", "to", true, true);
    ...
    public void tstDsnCopySecondaryConstructorWithInvalidRequestType() {
        ...
        IllegalStateException exception = assertThrows(
                ...
                () -> new DsnCopy(connection, request)
        );
